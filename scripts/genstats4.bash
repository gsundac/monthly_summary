...
PAIX_TOTAL=`echo "$AIX_TOTAL-$VAIX_TOTAL"| bc`
POTHEROS_TOTAL=`echo "$OTHEROS-$VOTHEROS"| bc`
PTOTALOSI=`echo "$PHPUX_TOTAL + $PRHEL_TOTAL + $PSUNOS_TOTAL + $PORAC_TOTAL + $PAIX_TOTAL + $POTHEROS_TOTAL" | bc`
...
LEBANON_TOTAL=`grep LEBANON $DATAFILE | wc -l`
DALLAS_TOTAL=`grep DALLAS $DATAFILE | wc -l`
UNDEFINED=`egrep -v "^$|REMOTE|ENB2|SEO|MLP|PLC|EDMTerm|LEBANON|DALLAS" $DATAFILE | wc -l`
TOTALLS=`echo "$MLP_TOTAL + $SEO_TOTAL + $ENB2_TOTAL + $LEBANON_TOTAL + $DALLAS_TOTAL + $REMOTE_TOTAL + $UNDEFINED" | bc` 
...
LEBANON_VTOTAL=`grep LEBANON $DATAFILE | egrep "VMware Virtual|NGC|HVM domU|LPAR" | wc -l`
DALLAS_VTOTAL=`grep DALLAS $DATAFILE | egrep "VMware Virtual|NGC|HVM domU|LPAR" | wc -l`
VTOTALLS=`echo "$MLP_VTOTAL + $SEO_VTOTAL + $ENB2_VTOTAL + $THOR_VTOTAL + $VPC_VTOTAL + $LEBANON_VTOTAL + $DALLAS_VTOTAL + $REMOTE_VTOTAL" | bc`
...
LEBANON_PTOTAL=`grep LEBANON $DATAFILE | egrep -v "VMware Virtual|NGC|HVM domU|LPAR" | wc -l`
DALLAS_PTOTAL=`grep DALLAS $DATAFILE | egrep -v "VMware Virtual|NGC|HVM domU|LPAR" | wc -l`
PTOTALLS=`echo "$EPL_PTOTAL + $MLP_PTOTAL + $SEO_PTOTAL + $ENB2_PTOTAL + $REMOTE_PTOTAL + $VPC_PTOTAL + $THOR_PTOTAL + $DALLAS_PTOTAL + $LEBANON_PTOTAL" | bc`
...
MLP_SUN_ORAC=`grep MLP $DATAFILE | egrep "Oracle VM server|Enterprise Linux Enterprise Linux" | egrep -v "VMware|HVM domU" | wc -l`
...
SEO_SUN_ORAC=`grep SEO $DATAFILE | egrep "Oracle VM server|Enterprise Linux Enterprise Linux" | egrep -v "VMware|HVM domU" | wc -l`
...
THOR_HP_ORAC=`grep THOR $DATAFILE | egrep "Oracle Linux|Enterprise Linux Enterprise Linux" | egrep -v VMware | egrep "ProLiant"| wc -l`
THOR_CISCO_RHEL=`grep THOR $DATAFILE | egrep "Red Hat|RHEL" | egrep -v VMware | egrep "BASE-|UCSB-|UCSC-"| wc -l`
THOR_CISCO_ORAC=`grep THOR $DATAFILE | egrep "Oracle Linux|Enterprise Linux Enterprise Linux" | egrep -v VMware | egrep "BASE-|UCSB-|UCSC-"| wc -l`
...
VPC_HP_ORAC=`grep VPC $DATAFILE | egrep "Oracle Linux|Enterprise Linux Enterprise Linux" | egrep -v VMware | egrep "ProLiant"| wc -l`
VPC_CISCO_RHEL=`grep VPC $DATAFILE | egrep "Red Hat|RHEL" | egrep -v VMware | egrep "BASE-|UCSB-|UCSC-"| wc -l`
VPC_CISCO_ORAC=`grep VPC $DATAFILE | egrep "Oracle Linux|Enterprise Linux Enterprise Linux" | egrep -v VMware | egrep "BASE-|UCSB-|UCSC-"| wc -l`
...
#
LEBANON_HP_RHEL=`grep LEBANON $DATAFILE | egrep "Red Hat|RHEL" | egrep -v VMware | egrep "ProLiant"| wc -l`
LEBANON_HP_ORAC=`grep LEBANON $DATAFILE | egrep "Oracle Linux|Enterprise Linux Enterprise Linux" | egrep -v VMware | egrep "ProLiant"| wc -l`
LEBANON_CISCO_RHEL=`grep LEBANON $DATAFILE | egrep "Red Hat|RHEL" | egrep -v VMware | egrep "BASE-|UCSB-|UCSC-"| wc -l`
LEBANON_CISCO_ORAC=`grep LEBANON $DATAFILE | egrep "Oracle Linux|Enterprise Linux Enterprise Linux" | egrep -v VMware | egrep "BASE-|UCSB-|UCSC-"| wc -l`
LEBANON_DELL_RHEL=`grep LEBANON $DATAFILE | egrep "Red Hat|RHEL" | egrep -v VMware | egrep "PowerEdge"| wc -l`
LEBANON_DELL_ORAC=`grep LEBANON $DATAFILE | egrep "Oracle Linux|Enterprise Linux Enterprise Linux Server" | egrep -v VMware | egrep "PowerEdge"| wc -l`
LEBANON_HPUX=`grep LEBANON $DATAFILE | egrep "HP-UX" | wc -l`
LEBANON_SOL=`grep LEBANON $DATAFILE | egrep "SunOS" | grep -v Global | wc -l`
LEBANON_HP_RHEL_CONSOLE=`grep LEBANON $DATAFILE | egrep "Red Hat|RHEL" | egrep -v VMware | egrep -i "HP Z8|workstation" | wc -l`
LEBANON_AIX=`grep LEBANON $DATAFILE | egrep "AIX" | grep -v LPAR | wc -l`
#
DALLAS_HP_RHEL=`grep DALLAS $DATAFILE | egrep "Red Hat|RHEL" | egrep -v VMware | egrep "ProLiant"| wc -l`
DALLAS_HP_ORAC=`grep DALLAS $DATAFILE | egrep "Oracle Linux|Enterprise Linux Enterprise Linux" | egrep -v VMware | egrep "ProLiant"| wc -l`
DALLAS_CISCO_RHEL=`grep DALLAS $DATAFILE | egrep "Red Hat|RHEL" | egrep -v VMware | egrep "BASE-|UCSB-|UCSC-"| wc -l`
DALLAS_CISCO_ORAC=`grep DALLAS $DATAFILE | egrep "Oracle Linux|Enterprise Linux Enterprise Linux" | egrep -v VMware | egrep "BASE-|UCSB-|UCSC-"| wc -l`
DALLAS_DELL_RHEL=`grep DALLAS $DATAFILE | egrep "Red Hat|RHEL" | egrep -v VMware | egrep "PowerEdge"| wc -l`
DALLAS_DELL_ORAC=`grep DALLAS $DATAFILE | egrep "Oracle Linux|Enterprise Linux Enterprise Linux Server" | egrep -v VMware | egrep "PowerEdge"| wc -l`
DALLAS_HPUX=`grep DALLAS $DATAFILE | egrep "HP-UX" | wc -l`
DALLAS_SOL=`grep DALLAS $DATAFILE | egrep "SunOS" | grep -v Global | wc -l`
DALLAS_HP_RHEL_CONSOLE=`grep DALLAS $DATAFILE | egrep "Red Hat|RHEL" | egrep -v VMware | egrep -i "HP Z8|workstation" | wc -l`
DALLAS_AIX=`grep DALLAS $DATAFILE | egrep "AIX" | grep -v LPAR | wc -l`
...
echo "LEBANON,AIX,6-7,$LEBANON_AIX"
echo "LEBANON,HP,RHEL,$LEBANON_HP_RHEL"
echo "DALLAS,AIX,6-7,$DALLAS_AIX"
echo "DALLAS,HP,RHEL,$DALLAS_HP_RHEL"
echo
echo "===========,============,==========,==========,=========="
...
echo "Total_AIX,$VAIX_TOTAL,$PAIX_TOTAL,$OAIX_TOTAL,$AIX_TOTAL"
...
echo "Lebanon,$LEBANON_VTOTAL,$LEBANON_PTOTAL,$LEBANON_TOTAL"
echo "Dallas,$DALLAS_VTOTAL,$DALLAS_PTOTAL,$DALLAS_TOTAL"
echo "-----------,---------,---------------,---------,---------"
