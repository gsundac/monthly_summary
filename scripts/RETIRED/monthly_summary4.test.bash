...
echo "Hostname, In Date, Report Date, DNS, Location, Uptime, Authentication, OS, Kernel, Hardware, Application Guess, IP Address, Serial Number, Procs, Mem, Age (M)" > $RES_PATH/allhosts.csv
