...
/usr/bin/mysql -uroot -pifa6isa9 -h cheddar ISS_UNIX_DATA -e "load data local infile '"$RES_PATH/allhosts-$DATE.csv"' into table base_data fields terminated by ',' lines terminated by '\n'" 
